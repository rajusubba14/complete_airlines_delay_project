...
# installed.
TK_PREFIX='/Users/rajusubba/Airlines_Delay_Data/myenv'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/rajusubba/Airlines_Delay_Data/myenv'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/rajusubba/Airlines_Delay_Data/myenv/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/rajusubba/Airlines_Delay_Data/myenv/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/rajusubba/Airlines_Delay_Data/myenv/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Users/rajusubba/Airlines_Delay_Data/myenv/lib/libtkstub8.6.a'
